...
const BASE_DIR = String.raw`C:\workspace\privateAi\limbus-workspace\crawled\Limbus Company\거울 던전\E.G.O 기프트`;
const OUTPATH  = String.raw`C:\workspace\privateAi\limbus-workspace\data\ego-gifts-raw.json`;
